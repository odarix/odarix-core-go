...
var (
	unsafeCall = promauto.NewCounterVec(
		prometheus.CounterOpts{
			Name: "odarix_core_cppbridge_unsafecall_nanoseconds",
...
func walProtobufHashdexCtor(limits WALHashdexLimits) uintptr {
	...
	fastcgo.UnsafeCall2(
		C.opcore_wal_protobuf_hashdex_ctor,
...
func walProtobufHashdexSnappyPresharding(
	...
	fastcgo.UnsafeCall2(
		C.opcore_wal_protobuf_hashdex_snappy_presharding,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func walProtobufHashdexGetMetadata(hashdex uintptr) []WALScraperHashdexMetadata {
	...
	fastcgo.UnsafeCall2(
		C.opcore_wal_protobuf_hashdex_get_metadata,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func walGoModelHashdexCtor(limits WALHashdexLimits) uintptr {
	...
	fastcgo.UnsafeCall2(
		C.opcore_wal_go_model_hashdex_ctor,
		uintptr(unsafe.Pointer(&limits)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func walGoModelHashdexPresharding(hashdex uintptr, data []model.TimeSeries) (cluster, replica string, err []byte) {
	...
	fastcgo.UnsafeCall2(
		C.opcore_wal_go_model_hashdex_presharding,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func walEncoderAddInnerSeries(encoder uintptr, innerSeries []*InnerSeries) (stats WALEncoderStats, exception []byte) {
	...
	fastcgo.UnsafeCall2(
		C.opcore_wal_encoder_add_inner_series,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func walEncoderAddRelabeledSeries(
	...
	fastcgo.UnsafeCall2(
		C.opcore_wal_encoder_add_relabeled_series,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func walEncoderAddWithStaleNans(
	...
	fastcgo.UnsafeCall2(
		C.opcore_wal_encoder_add_with_stale_nans,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func walEncoderCollectSource(encoder, sourceState uintptr, staleTS int64) (stats WALEncoderStats, exception []byte) {
	...
	fastcgo.UnsafeCall2(
		C.opcore_wal_encoder_collect_source,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func walEncoderLightweightCtor(shardID uint16, logShards uint8) uintptr {
	...
	fastcgo.UnsafeCall2(
		C.opcore_wal_encoder_lightweight_ctor,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func walEncoderLightweightAdd(encoder, hashdex uintptr) (stats WALEncoderStats, exception []byte) {
	...
	fastcgo.UnsafeCall2(
		C.opcore_wal_encoder_lightweight_add,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func walEncoderLightweightAddInnerSeries(
	...
	fastcgo.UnsafeCall2(
		C.opcore_wal_encoder_lightweight_add_inner_series,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func walEncoderLightweightAddRelabeledSeries(
	...
	fastcgo.UnsafeCall2(
		C.opcore_wal_encoder_lightweight_add_relabeled_series,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func walEncoderLightweightFinalize(encoder uintptr) (stats WALEncoderStats, segment, exception []byte) {
	...
	fastcgo.UnsafeCall2(
		C.opcore_wal_encoder_lightweight_finalize,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func walEncoderLightweightDtor(encoder uintptr) {
	...
	fastcgo.UnsafeCall1(
		C.opcore_wal_encoder_lightweight_dtor,
		uintptr(unsafe.Pointer(&args)),
	)
}
...
func walDecoderDecodeToHashdex(
	...
	fastcgo.UnsafeCall2(
		C.opcore_wal_decoder_decode_to_hashdex,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func walDecoderDecodeToHashdexWithMetricInjection(
	...
	fastcgo.UnsafeCall2(
		C.opcore_wal_decoder_decode_to_hashdex_with_metric_injection,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func walDecoderDecodeDry(decoder uintptr, segment []byte) (segmentID uint32, err []byte) {
	...
	fastcgo.UnsafeCall2(
		C.opcore_wal_decoder_decode_dry,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func walDecoderRestoreFromStream(
	...
	fastcgo.UnsafeCall2(
		C.opcore_wal_decoder_restore_from_stream,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func walOutputDecoderCtor(
	...
	fastcgo.UnsafeCall2(
		C.opcore_wal_output_decoder_ctor,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func walOutputDecoderDtor(decoder uintptr) {
	...
	fastcgo.UnsafeCall1(
		C.opcore_wal_output_decoder_dtor,
		uintptr(unsafe.Pointer(&args)),
	)
}
...
func walOutputDecoderDumpTo(decoder uintptr) (dump, err []byte) {
	...
	fastcgo.UnsafeCall2(
		C.opcore_wal_output_decoder_dump_to,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func walOutputDecoderLoadFrom(decoder uintptr, dump []byte) []byte {
	...
	fastcgo.UnsafeCall2(
		C.opcore_wal_output_decoder_load_from,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func walOutputDecoderDecode(
	...
	fastcgo.UnsafeCall2(
		C.opcore_wal_output_decoder_decode,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func primitivesLSSAllocatedMemory(lss uintptr) uint64 {
	...
	fastcgo.UnsafeCall2(
		C.opcore_primitives_lss_allocated_memory,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func primitivesLSSFindOrEmplace(lss uintptr, labelSet model.LabelSet) uint32 {
	...
	fastcgo.UnsafeCall2(
		C.opcore_primitives_lss_find_or_emplace,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func primitivesLSSGetLabelSets(lss uintptr, labelSetIDs []uint32) []Labels {
	...
	fastcgo.UnsafeCall2(
		C.opcore_primitives_lss_get_label_sets,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func primitivesLSSFreeLabelSets(labelSets []Labels) {
	...
	fastcgo.UnsafeCall1(
		C.opcore_primitives_lss_free_label_sets,
		uintptr(unsafe.Pointer(&args)),
	)
}
...
func primitivesLSSQueryLabelNames(lss uintptr, matchers []model.LabelMatcher) (uint32, []string) {
	...
	fastcgo.UnsafeCall2(
		C.opcore_primitives_lss_query_label_names,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func primitivesLSSQueryLabelValues(lss uintptr, label_name string, matchers []model.LabelMatcher) (uint32, []string) {
	...
	fastcgo.UnsafeCall2(
		C.opcore_primitives_lss_query_label_values,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func prometheusStatelessRelabelerCtor(cfgs []*RelabelConfig) (statelessRelabeler uintptr, exception []byte) {
	...
	fastcgo.UnsafeCall2(
		C.opcore_prometheus_stateless_relabeler_ctor,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func prometheusStatelessRelabelerDtor(statelessRelabeler uintptr) {
	...
	fastcgo.UnsafeCall1(
		C.opcore_prometheus_stateless_relabeler_dtor,
		uintptr(unsafe.Pointer(&args)),
	)
}
...
func prometheusStatelessRelabelerResetTo(statelessRelabeler uintptr, cfgs []*RelabelConfig) (exception []byte) {
	...
	fastcgo.UnsafeCall2(
		C.opcore_prometheus_stateless_relabeler_reset_to,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func prometheusInnerSeriesCtor(innerSeries *InnerSeries) {
	...
	fastcgo.UnsafeCall1(
		C.opcore_prometheus_inner_series_ctor,
		uintptr(unsafe.Pointer(&args)),
	)
}
...
func prometheusInnerSeriesDtor(innerSeries *InnerSeries) {
	...
	fastcgo.UnsafeCall1(
		C.opcore_prometheus_inner_series_dtor,
		uintptr(unsafe.Pointer(&args)),
	)
}
...
func prometheusRelabeledSeriesCtor(relabeledSeries *RelabeledSeries) {
	...
	fastcgo.UnsafeCall1(
		C.opcore_prometheus_relabeled_series_ctor,
		uintptr(unsafe.Pointer(&args)),
	)
}
...
func prometheusRelabeledSeriesDtor(relabeledSeries *RelabeledSeries) {
	...
	fastcgo.UnsafeCall1(
		C.opcore_prometheus_relabeled_series_dtor,
		uintptr(unsafe.Pointer(&args)),
	)
}
...
func prometheusRelabelerStateUpdateCtor(relabelerStateUpdate *RelabelerStateUpdate) {
	...
	fastcgo.UnsafeCall1(
		C.opcore_prometheus_relabeler_state_update_ctor,
		uintptr(unsafe.Pointer(&args)),
	)
}
...
func prometheusRelabelerStateUpdateDtor(relabelerStateUpdate *RelabelerStateUpdate) {
	...
	fastcgo.UnsafeCall1(
		C.opcore_prometheus_relabeler_state_update_dtor,
		uintptr(unsafe.Pointer(&args)),
	)
}
...
func prometheusRelabelStaleNansStateCtor() uintptr {
	...
	fastcgo.UnsafeCall1(
		C.opcore_prometheus_relabel_stalenans_state_ctor,
		uintptr(unsafe.Pointer(&res)),
	)
...
func prometheusRelabelStaleNansStateReset(state uintptr) {
	...
	fastcgo.UnsafeCall1(
		C.opcore_prometheus_relabel_stalenans_state_reset,
		uintptr(unsafe.Pointer(&args)),
	)
}
...
func prometheusRelabelStaleNansStateDtor(state uintptr) {
	...
	fastcgo.UnsafeCall1(
		C.opcore_prometheus_relabel_stalenans_state_dtor,
		uintptr(unsafe.Pointer(&args)),
	)
}
...
func prometheusPerShardRelabelerCtor(
	...
	fastcgo.UnsafeCall2(
		C.opcore_prometheus_per_shard_relabeler_ctor,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func prometheusPerShardRelabelerDtor(perShardRelabeler uintptr) {
	...
	fastcgo.UnsafeCall1(
		C.opcore_prometheus_per_shard_relabeler_dtor,
		uintptr(unsafe.Pointer(&args)),
	)
}
...
func prometheusPerShardRelabelerCacheAllocatedMemory(perShardRelabeler uintptr) uint64 {
	...
	fastcgo.UnsafeCall2(
		C.opcore_prometheus_per_shard_relabeler_cache_allocated_memory,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func prometheusPerShardRelabelerInputRelabeling(
	...
	start := time.Now()
	fastcgo.UnsafeCall2(
		C.opcore_prometheus_per_shard_relabeler_input_relabeling,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
	unsafeCall.With(
...
func prometheusPerShardRelabelerInputRelabelingWithStalenans(
	...
	start := time.Now()
	fastcgo.UnsafeCall2(
		C.opcore_prometheus_per_shard_relabeler_input_relabeling_with_stalenans,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
	unsafeCall.With(
...
func prometheusPerShardRelabelerAppendRelabelerSeries(
	...
	start := time.Now()
	fastcgo.UnsafeCall2(
		C.opcore_prometheus_per_shard_relabeler_append_relabeler_series,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
	unsafeCall.With(
...
func prometheusPerShardRelabelerUpdateRelabelerState(
	...
	start := time.Now()
	fastcgo.UnsafeCall2(
		C.opcore_prometheus_per_shard_relabeler_update_relabeler_state,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
	unsafeCall.With(
...
func prometheusPerShardRelabelerOutputRelabeling(
	...
	fastcgo.UnsafeCall2(
		C.opcore_prometheus_per_shard_relabeler_output_relabeling,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func prometheusPerShardRelabelerResetTo(
	...
	start := time.Now()
	fastcgo.UnsafeCall1(
		C.opcore_prometheus_per_shard_relabeler_reset_to,
		uintptr(unsafe.Pointer(&args)),
	)
	unsafeCall.With(
...
func seriesDataDataStorageCtor() uintptr {
	...
	fastcgo.UnsafeCall1(
		C.opcore_series_data_data_storage_ctor,
		uintptr(unsafe.Pointer(&res)),
	)
...
func seriesDataDataStorageReset(dataStorage uintptr) {
	...
	start := time.Now()
	fastcgo.UnsafeCall1(
		C.opcore_series_data_data_storage_reset,
		uintptr(unsafe.Pointer(&args)),
	)
	unsafeCall.With(
...
func seriesDataDataStorageAllocatedMemory(dataStorage uintptr) uint64 {
	...
	start := time.Now()
	fastcgo.UnsafeCall2(
		C.opcore_series_data_data_storage_allocated_memory,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
	unsafeCall.With(
...
func seriesDataDataStorageQuery(dataStorage uintptr, query HeadDataStorageQuery) []byte {
	...
	start := time.Now()
	fastcgo.UnsafeCall2(
		C.opcore_series_data_data_storage_query,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
	unsafeCall.With(
...
func seriesDataDataStorageTimeInterval(dataStorage uintptr) TimeInterval {
	...
	fastcgo.UnsafeCall2(
		C.opcore_series_data_data_storage_time_interval,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func seriesDataDataStorageDtor(dataStorage uintptr) {
	...
	fastcgo.UnsafeCall1(
		C.opcore_series_data_data_storage_dtor,
		uintptr(unsafe.Pointer(&args)),
	)
}
...
func seriesDataEncoderCtor(dataStorage uintptr) uintptr {
	...
	fastcgo.UnsafeCall2(
		C.opcore_series_data_encoder_ctor,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func seriesDataEncoderEncode(encoder uintptr, seriesID uint32, timestamp int64, value float64) {
	...
	start := time.Now()
	fastcgo.UnsafeCall1(
		C.opcore_series_data_encoder_encode,
		uintptr(unsafe.Pointer(&args)),
	)
	unsafeCall.With(
...
func seriesDataEncoderEncodeInnerSeriesSlice(encoder uintptr, innerSeriesSlice []*InnerSeries) {
	...
	start := time.Now()
	fastcgo.UnsafeCall1(
		C.opcore_series_data_encoder_encode_inner_series_slice,
		uintptr(unsafe.Pointer(&args)),
	)
	unsafeCall.With(
...
func seriesDataEncoderMergeOutOfOrderChunks(encoder uintptr) {
	...
	start := time.Now()
	fastcgo.UnsafeCall1(
		C.opcore_series_data_encoder_merge_out_of_order_chunks,
		uintptr(unsafe.Pointer(&args)),
	)
	unsafeCall.With(
...
func seriesDataEncoderDtor(encoder uintptr) {
	...
	fastcgo.UnsafeCall1(
		C.opcore_series_data_encoder_dtor,
		uintptr(unsafe.Pointer(&args)),
	)
}
...
func seriesDataDeserializerCtor(serializedChunks []byte) uintptr {
	...
	fastcgo.UnsafeCall2(
		C.opcore_series_data_deserializer_ctor,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func seriesDataDeserializerCreateDecodeIterator(deserializer uintptr, chunkMetadata []byte) uintptr {
	...
	fastcgo.UnsafeCall2(
		C.opcore_series_data_deserializer_create_decode_iterator,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func seriesDataDecodeIteratorNext(decodeIterator uintptr) bool {
	...
	fastcgo.UnsafeCall2(
		C.opcore_series_data_decode_iterator_next,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func seriesDataDecodeIteratorSample(decodeIterator uintptr) (int64, float64) {
	...
	fastcgo.UnsafeCall2(
		C.opcore_series_data_decode_iterator_sample,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func seriesDataDecodeIteratorDtor(decodeIterator uintptr) {
	...
	fastcgo.UnsafeCall1(
		C.opcore_series_data_decode_iterator_dtor,
		uintptr(unsafe.Pointer(&args)),
	)
}
...
func seriesDataDeserializerDtor(deserializer uintptr) {
	...
	fastcgo.UnsafeCall1(
		C.opcore_series_data_deserializer_dtor,
		uintptr(unsafe.Pointer(&args)),
	)
}
...
func seriesDataChunkRecoderCtor(lss, dataStorage uintptr, timeInterval TimeInterval) uintptr {
	...
	fastcgo.UnsafeCall2(
		C.opcore_series_data_chunk_recoder_ctor,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func seriesDataChunkRecoderRecodeNextChunk(chunkRecoder uintptr, recodedChunk *RecodedChunk) {
	...
	start := time.Now()
	fastcgo.UnsafeCall2(
		C.opcore_series_data_chunk_recoder_recode_next_chunk,
		uintptr(unsafe.Pointer(&args)),
...
func seriesDataChunkRecoderDtor(chunkRecoder uintptr) {
	...
	fastcgo.UnsafeCall1(
		C.opcore_series_data_chunk_recoder_dtor,
		uintptr(unsafe.Pointer(&args)),
	)
}
...
func indexWriterWriteHeader(writer uintptr, data []byte) []byte {
	...
	fastcgo.UnsafeCall2(
		C.opcore_index_writer_write_header,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func indexWriterWriteSymbols(writer uintptr, data []byte) []byte {
	...
	fastcgo.UnsafeCall2(
		C.opcore_index_writer_write_symbols,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func indexWriterWriteNextSeriesBatch(writer uintptr, ls_id uint32, chunks_meta []ChunkMetadata, data []byte) []byte {
	...
	fastcgo.UnsafeCall2(
		C.opcore_index_writer_write_next_series_batch,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func indexWriterWriteLabelIndices(writer uintptr, data []byte) []byte {
	...
	fastcgo.UnsafeCall2(
		C.opcore_index_writer_write_label_indices,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func indexWriterWriteNextPostingsBatch(writer uintptr, max_batch_size uint32, data []byte) ([]byte, bool) {
	...
	fastcgo.UnsafeCall2(
		C.opcore_index_writer_write_next_postings_batch,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func indexWriterWriteLabelIndicesTable(writer uintptr, data []byte) []byte {
	...
	fastcgo.UnsafeCall2(
		C.opcore_index_writer_write_label_indices_table,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func indexWriterWritePostingsTableOffsets(writer uintptr, data []byte) []byte {
	...
	fastcgo.UnsafeCall2(
		C.opcore_index_writer_write_postings_table_offsets,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func indexWriterWriteTableOfContents(writer uintptr, data []byte) []byte {
	...
	fastcgo.UnsafeCall2(
		C.opcore_index_writer_write_table_of_contents,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func walPrometheusScraperHashdexCtor() uintptr {
	...
	fastcgo.UnsafeCall1(
		C.opcore_wal_prometheus_scraper_hashdex_ctor,
		uintptr(unsafe.Pointer(&res)),
	)
...
func walPrometheusScraperHashdexParse(hashdex uintptr, buffer []byte, default_timestamp int64) (uint32, uint32) {
	...
	start := time.Now()
	fastcgo.UnsafeCall2(
		C.opcore_wal_prometheus_scraper_hashdex_parse,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
	unsafeCall.With(
...
func walPrometheusScraperHashdexGetMetadata(hashdex uintptr) []WALScraperHashdexMetadata {
	...
	fastcgo.UnsafeCall2(
		C.opcore_wal_prometheus_scraper_hashdex_get_metadata,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func walOpenMetricsScraperHashdexCtor() uintptr {
	...
	fastcgo.UnsafeCall1(
		C.opcore_wal_open_metrics_scraper_hashdex_ctor,
		uintptr(unsafe.Pointer(&res)),
	)
...
func walOpenMetricsScraperHashdexParse(hashdex uintptr, buffer []byte, default_timestamp int64) (uint32, uint32) {
	...
	start := time.Now()
	fastcgo.UnsafeCall2(
		C.opcore_wal_open_metrics_scraper_hashdex_parse,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
	unsafeCall.With(
...
func walOpenMetricsScraperHashdexGetMetadata(hashdex uintptr) []WALScraperHashdexMetadata {
	...
	fastcgo.UnsafeCall2(
		C.opcore_wal_open_metrics_scraper_hashdex_get_metadata,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func prometheusCacheCtor() uintptr {
	...
	fastcgo.UnsafeCall1(
		C.opcore_prometheus_cache_ctor,
		uintptr(unsafe.Pointer(&res)),
	)
...
func prometheusCacheDtor(cache uintptr) {
	...
	fastcgo.UnsafeCall1(
		C.opcore_prometheus_cache_dtor,
		uintptr(unsafe.Pointer(&args)),
	)
}
...
func prometheusCacheAllocatedMemory(cache uintptr) uint64 {
	...
	fastcgo.UnsafeCall2(
		C.opcore_prometheus_cache_allocated_memory,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func prometheusCacheResetTo(cache uintptr) {
	...
	fastcgo.UnsafeCall1(
		C.opcore_prometheus_cache_reset_to,
		uintptr(unsafe.Pointer(&args)),
	)
}
...
func headWalEncoderCtor(shardID uint16, logShards uint8, lss uintptr) uintptr {
	...
	fastcgo.UnsafeCall2(
		C.opcore_head_wal_encoder_ctor,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func headWalEncoderAddInnerSeries(encoder uintptr, innerSeries []*InnerSeries) (stats WALEncoderStats, err error) {
	...
	fastcgo.UnsafeCall2(
		C.opcore_head_wal_encoder_add_inner_series,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func headWalEncoderFinalize(encoder uintptr) (stats WALEncoderStats, segment []byte, err error) {
	...
	fastcgo.UnsafeCall2(
		C.opcore_head_wal_encoder_finalize,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func headWalEncoderDtor(encoder uintptr) {
	...
	fastcgo.UnsafeCall1(
		C.opcore_head_wal_encoder_dtor,
		uintptr(unsafe.Pointer(&args)),
	)
}
...
func headWalDecoderCtor(lss uintptr, encoderVersion uint8) uintptr {
	...
	fastcgo.UnsafeCall2(
		C.opcore_head_wal_decoder_ctor,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func headWalDecoderCreateEncoder(decoder uintptr) uintptr {
	...
	fastcgo.UnsafeCall2(
		C.opcore_head_wal_encoder_ctor_from_decoder,
		uintptr(unsafe.Pointer(&args)),
		uintptr(unsafe.Pointer(&res)),
	)
...
func headWalDecoderDtor(decoder uintptr) {
	...
	fastcgo.UnsafeCall1(
		C.opcore_head_wal_decoder_dtor,
		uintptr(unsafe.Pointer(&args)),
	)
}
