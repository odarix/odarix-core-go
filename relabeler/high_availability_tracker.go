	...
	ha := &HighAvailabilityTracker{
		...
		electedReplicaChanges: factory.NewCounterVec(
			prometheus.CounterOpts{
				Name: "odarix_core_delivery_high_availability_tracker_elected_replica_changes",
		...
		electedReplicaTimestamp: factory.NewGaugeVec(
			prometheus.GaugeOpts{
				Name: "odarix_core_delivery_high_availability_tracker_elected_replica_timestamp_seconds",
		...
		lastElectionTimestamp: factory.NewGaugeVec(
			prometheus.GaugeOpts{
				Name: "odarix_core_delivery_high_availability_tracker_last_election_timestamp_seconds",
				Help: "The timestamp stored for the currently elected replica.",
			},
			[]string{"cluster", "replica"},
		),
		deletedReplicas: factory.NewCounter(
			prometheus.CounterOpts{
				Name: "odarix_core_delivery_high_availability_tracker_deleted_total",
				Help: "Number of elected replicas deleted from store.",
			},
		),
		dropedReplicas: factory.NewCounter(
			prometheus.CounterOpts{
				Name: "odarix_core_delivery_high_availability_tracker_droped_total",
